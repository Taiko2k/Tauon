...
However once again, you can install from it's [SB](https://slackbuilds.org/repository/14.2/audio/tauonmb/) on **Slackware** distributions. (See, [here](https://youtu.be/kPqLctyBIag))
___
